...
namespace LaPizzaria.Data.Migrations
{
    ...
    [Migration("20260402205546_AddIngredientCategoriesVoucherWindowUpsale")]
    partial class AddIngredientCategoriesVoucherWindowUpsale
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LaPizzaria.Models.IngredientCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LaPizzaria.Models.Order", b =>
                {
                    ...
                    b.Property<string>("ShipperLocationIp")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LaPizzaria.Models.Voucher", b =>
                {
                    ...
                    b.Property<bool>("UpsaleRequiresSlowSeller")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("WindowTimeEndMinute")
                        .HasColumnType("int");

                    b.Property<int?>("WindowTimeStartMinute")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LaPizzaria.Models.Ingredient", b =>
                {
                    b.HasOne("LaPizzaria.Models.IngredientCategory", "Category")
            ...
            modelBuilder.Entity("LaPizzaria.Models.IngredientCategory", b =>
                {
                    b.HasOne("LaPizzaria.Models.IngredientCategory", "Parent")
                        .WithMany("Children")
